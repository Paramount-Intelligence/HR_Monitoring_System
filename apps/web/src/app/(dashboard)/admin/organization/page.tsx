  ...
  return (
    <div className="flex flex-col gap-6 p-6 w-full max-w-full overflow-x-hidden animate-in fade-in duration-700 pb-20 text-[var(--text-primary)]">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mt-4">
        <div className="w-full border-b border-[var(--border-subtle)] mb-8">
            <TabsList className="h-16 p-1 bg-transparent rounded-none border-none">
                <TabsTrigger value="departments" className="h-14 px-8 rounded-none border-b-2 border-transparent font-black text-[10px] uppercase tracking-widest data-[state=active]:border-[var(--accent-primary)] data-[state=active]:text-[var(--accent-primary)] transition-all bg-transparent shadow-none">
                    <Building className="mr-2 h-4 w-4" /> Departments
                </TabsTrigger>
                <TabsTrigger value="shifts" className="h-14 px-8 rounded-none border-b-2 border-transparent font-black text-[10px] uppercase tracking-widest data-[state=active]:border-[var(--accent-primary)] data-[state=active]:text-[var(--accent-primary)] transition-all bg-transparent shadow-none">
                    <Clock className="mr-2 h-4 w-4" /> Work Shifts
                </TabsTrigger>
                <TabsTrigger value="holidays" className="h-14 px-8 rounded-none border-b-2 border-transparent font-black text-[10px] uppercase tracking-widest data-[state=active]:border-[var(--accent-primary)] data-[state=active]:text-[var(--accent-primary)] transition-all bg-transparent shadow-none">
                    <Calendar className="mr-2 h-4 w-4" /> Holidays
                </TabsTrigger>
                <TabsTrigger value="announcements" className="h-14 px-8 rounded-none border-b-2 border-transparent font-black text-[10px] uppercase tracking-widest data-[state=active]:border-[var(--accent-primary)] data-[state=active]:text-[var(--accent-primary)] transition-all bg-transparent shadow-none">
